...
extension UIAlertController{
    class func creatAlertView(title:String ,message:String ,okAction:UIAlertAction,cancelAction:UIAlertAction,style:UIAlertControllerStyle = .alert) -> UIAlertController{
