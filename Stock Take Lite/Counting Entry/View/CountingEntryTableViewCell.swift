...
class CountingEntryTableViewCell: UITableViewCell {
    ...
    func addPhoneCountingEntryConstraint(){
        ...
        countQtyTextField.snp.makeConstraints { (make) in
        ...
        countQtyLeftLabel.snp.makeConstraints { (make) in
            ...
            make.top.equalTo(self.contentView.snp.top);
            make.left.equalTo(self.countQtyTextField.snp.right);
            make.width.equalTo(1);
            make.bottom.equalTo(self.contentView.snp.bottom);
        }
        varianceQtyLabel.snp.makeConstraints { (make) in
            
            make.top.equalTo(self.countQtyTextField.snp.top);
            make.left.equalTo(self.countQtyTextField.snp.right).offset(0);
            make.width.equalTo(SCREENWIDTH/6);
            make.bottom.equalTo(self.skuCodeLabel.snp.bottom);
    ...
    func addCountingEntryConstraint(){
        ...
        varianceQtyLabel.snp.makeConstraints { (make) in
            ...
            make.top.equalTo(self.countQtyTextField.snp.top);
            make.left.equalTo(self.countQtyTextField.snp.right).offset(25);
